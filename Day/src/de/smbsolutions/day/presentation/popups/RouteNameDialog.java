     ...
     // Get the layout inflater
        ...
        builder.setPositiveButton("Create", new DialogInterface.OnClickListener() {
                   public void onClick(DialogInterface dialog, int id) {
                	   ...
                	   EditText nameText = (EditText) getDialog().findViewById(R.id.routename);
                	   String test = nameText.getText().toString();
                	   //Calling the db
                	   Database.registerNewRoute(test);
                	   
                	  db.addNewRoutePoint(tracker.getLatitude(), tracker.getLongitude(), new Timestamp(System.currentTimeMillis()));
